...
public class UsuarioController {
    ...
    public String Busqueda(@ModelAttribute("Usuario") Usuario usuario, Model model) {
        RestTemplate restTemplate = new RestTemplate();
        Result Result = null;
        ResponseEntity<Result<Usuario>> responseEntityUsuario = restTemplate.exchange(rutaBase + "api/usuario/busqueda",
                HttpMethod.POST, usuario, new ParameterizedTypeReference<Result<Pais>>() {
                });
    ...
    // redirectAttributes.addFlashAttribute("Success", "El archivo fue leido
    // Correctamente");
    ...
    // redirectAttributes.addFlashAttribute("Error", "No hay ningún archivo
    ...
    // public String DeleteUsuario(@PathVariable("idUsuario") int idUsuario, Model
    // model,
    // RedirectAttributes redirectAttributes) {
    // Result Result = usuarioJPADAOImplementation.Delete(idUsuario);
    // if (Result.Correct) {
    // redirectAttributes.addFlashAttribute("Success", "El usuario fue eliminado
    // correctamente");
    // } else {
    // redirectAttributes.addFlashAttribute("Error", "El usuario No fue eliminado
    // correctamente");
    // }
    // return "redirect:/Usuario";
    // }
    ...
    // model.addAttribute("Paises", paisJPADAOImplementation.GetAll().Objects);
    // model.addAttribute("Roles", rolJPADAOImplementation.GetAll().Objects);
    // model.addAttribute("Failed", "Usuario No Fue Agregado correctamente,
    // Verifique los datos");
    // return "Formulario";
    // } else {
    // Result Result = usuarioJPADAOImplementation.Add(usuario);
    // if (Result.Correct) {
    // redirectAttributes.addFlashAttribute("Success", "Usuario Fue Guardado
    // correctamente");
    // } else {
    // redirectAttributes.addFlashAttribute("Error", "Algo salió Mal :(");
    // }
    ...
    // model.addAttribute("Paises", paisJPADAOImplementation.GetAll().Objects);
    // model.addAttribute("Roles", rolJPADAOImplementation.GetAll().Objects);
    // redirectAttributes.addFlashAttribute("FailedEdicion", "Usuario No Fue Editado
    // correctamente");
    ...
    // if (Result.Correct) {
    // redirectAttributes.addFlashAttribute("SuccessEdicion", "Usuario Editado
    // correctamente");
    ...
    // @PathVariable("idUsuario") int idUsuario, RedirectAttributes
    // redirectAttributes) {

    // Result Result = direccionJPAImplementation.Delete(idDireccion);
    // if (Result.Correct) {
    // redirectAttributes.addFlashAttribute("SuccessDeleteDireccion", "La Direccion
    // fue eliminada correctamente");
    // } else {
    // redirectAttributes.addFlashAttribute("ErrorDeleteDireccion", "La Direccion No
    // fue eliminada correctamente");
    // }
    // return "redirect:/Usuario/" + idUsuario;
    // }
    ...
    // usuarioJPADAOImplementation.GetById(idUsuario).Object);
    ...
    // if (Result.Correct) {
    // redirectAttributes.addFlashAttribute("SuccessAddDireccion", "Direccion
    ...
    // model.addAttribute("Paises", paisJPADAOImplementation.GetAll().Objects);
    // redirectAttributes.addFlashAttribute("ErrorEdicionDireccion", "La dirección
    // no pudo ser editada");
    // redirectAttributes.addFlashAttribute("IdDireccion",
    ...
    // if (Result.Correct) {
    // redirectAttributes.addFlashAttribute("SuccessEdicionDireccion", "Direccion
    ...
    // @ResponseBody
    // public Result (@PathVariable("IdPais") int IdPais) {
    ...
    // @ResponseBody
    // public Result getColoniaByMunicipio(@PathVariable("IdMunicipio") int
    // IdMunicipio) {
    // Result Result =
    // coloniaJPADAOImplementation.getColoniaByMunicipio(IdMunicipio);
    // return Result;
    // }
    ...
    // if (Datos.length < 16) {
    // System.out.println("La Linea " + NumeroLinea + " NO TIENE EL FORMATO
    // CORRECTO");
    ...
    // direccion.Colonia.setIdColonia((int)
